...
rhksgml54 added 12 commits 2 months ago
@rhksgml54
add sprint5 base
1acaccf
@rhksgml54
Revert "add sprint5 base" 
9dc566c
@rhksgml54
chore: base
6e6c445
@rhksgml54
feat: 예외 처리 고도화 (ErrorCode, DiscodeitException, 도메인별 예외, ErrorResponse)
a1b134b
@rhksgml54
feat: 유효성 검사 추가 (@Valid, @notblank, @Email, MethodArgumentNotValidExc… 
46b41fc
@rhksgml54
feat: logback-spring.xml 추가 (콘솔/파일 출력, dev/prod 환경 분리)
b52f151
@rhksgml54
chore: 11-sprint-mission3 폴더 추적 제거
2aeb4d4
@rhksgml54
feat: 서비스/컨트롤러 레이어 로그 추가
c7486f3
@rhksgml54
feat: Actuator 엔드포인트 설정 추가
cc0b572
@rhksgml54
test: 서비스 레이어 단위 테스트 추가 (User, Channel, Message)
d92d149
@rhksgml54
test: Repository 슬라이스 테스트 추가
60aa32f
@rhksgml54
test: Controller 슬라이스 테스트 추가