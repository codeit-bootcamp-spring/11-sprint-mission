...
public class DiscodeitApplication {
	...
	public static void main(String[] args) {
		...
		UserResponse user1 = userService.createUser(new CreateUserRequest("Alice", "alice@example.com", "password1", null));
		UserResponse user2 = userService.createUser(new CreateUserRequest("Bob", "bob@example.com", "password2", null));
		UserResponse user3 = userService.createUser(new CreateUserRequest("Charlie", "charlie@example.com", "password3", null));
		...
		UserResponse updatedUser = userService.updateUser(user1.getUserId(), new UpdateUserRequest("Alice Smith", "alice.smith@example.com", "newpassword", null));
