...
function qm() {
  ...
  var r = Symbol.for("react.element"), i = Symbol.for("react.portal"),
      ...
      u = Symbol.for("react.strict_mode"), c = Symbol.for("react.profiler"),
      d = Symbol.for("react.provider"),
      p = Symbol.for("react.context"), m = Symbol.for("react.forward_ref"),
      v = Symbol.for("react.suspense"),
      x = Symbol.for("react.memo"), E = Symbol.for("react.lazy"),
      j = Symbol.iterator;
...
` + l[f].replace(" at new ", " at ");
  ...
  var ga = i.unstable_scheduleCallback, ya = i.unstable_cancelCallback,
      ...
      oh = i.unstable_requestPaint, _e = i.unstable_now,
      ...
      sh = i.unstable_LowPriority, wa = i.unstable_IdlePriority, _o = null,
      Mt = null;
  ...
  var Ja = Wo("animationend"), Za = Wo("animationiteration"),
      ec = Wo("animationstart"), tc = Wo("transitionend"),
      nc = new Map,
  ...
  function sc(e, t, n, o) {
    ...
    !== "touchmove" && t !== "wheel" || (l = !0), o ? l !== void 0
        ...
        n, {passive: l}) : e.addEventListener(t, n, !1)
  }
    ...
    fa(function () {
      ...
      if (!(t & 7)) {
        ...
        && (re = new Ta(re, e, null, n, M), U.push({
          event: re,
          listeners: te
        }), ne ? re.data = ne : (ne = Fa(n), ne !== null
        && (re.data = ne)))), (ne = Hh ? Vh(e, n) : Wh(e, n)) && (A = qo(A,
            "onBeforeInput"), 0 < A.length && (M = new Ta("onBeforeInput",
            "beforeinput", null, n, M), U.push({
          event: M,
          listeners: A
        }), M.data = ne))
      }
...
`).replace(im, "")
  ...
  var rr = Math.random().toString(36).slice(2), Ut = "__reactFiber$" + rr,
      Xr = "__reactProps$" + rr,
      Gt = "__reactContainer$" + rr, rl = "__reactEvents$" + rr,
...
` + a.stack
  ...
  function Pm(e, t) {
    ...
    for (Zs = {
      ...
      if (t = G, e = t.child, (t.subtreeFlags
          & 1028) !== 0 && e !== null) {
        e.return = t, G = e;
      } else {
        for (;
  ...
  var Im = Math.ceil, vi = K.ReactCurrentDispatcher, Wl = K.ReactCurrentOwner,
      kt = K.ReactCurrentBatchConfig, me = 0,
      Me = null, Oe = null, He = 0, pt = 0, gr = dn(0), De = 0, ao = null,
      Tn = 0, wi = 0, Ql = 0, co = null,
      ot = null, ql = 0, yr = 1 / 0, tn = null, xi = !1, bl = null, vn = null,
      Si = !1, wn = null, ki = 0, fo = 0,
      Gl = null, Ei = -1, Ci = 0;
...
var Ae = "-ms-", wo = "-moz-", we = "-webkit-", Gd = "comm", ns = "rule",
    $u = "decl", tg = "@import",
    Yd = "@keyframes", ng = "@layer", Kd = Math.abs, Hu = String.fromCharCode,
    Cu = Object.assign;
...
var Ng = Object.defineProperty, Og = Object.getOwnPropertyNames,
    ...
    Tg = Object.getOwnPropertyDescriptor, Lg = Object.getPrototypeOf,
    sd = Object.prototype;
  ...
  function F(K, $) {
    return function (T, H, se) {
      var Ve = T.attrs, At = T.componentStyle, qt = T.defaultProps,
          ...
          Je = T.styledComponentId, at = T.target, yt = rn.useContext(Zi),
          We = cd(),
...
const Xe = {apiBaseUrl: "/api"}, Dt = bn(r => ({
  users: [], fetchUsers: async () => {
    ...
    try {
      await he.patch(`${Xe.apiBaseUrl}/users/${i}/user-status`,
  ...
  profileImages: {}, fetchProfileImage: async i => {
    try {
      const s = await he.get(`${Xe.apiBaseUrl}/binary-contents/${i}`),
          u = s.data.data.bytes,
          d = `data:${s.data.data.contentType};base64,${u}`;
...
function Md({channel: r, isActive: i, onClick: s, hasUnread: u}) {
  ...
  const m = r.participants.map(x => d.find(E => E.id === x)).filter(Boolean);
  if (m.length > 2) {
  ...
  return g.jsxs(yd, {
    ...
    children: [g.jsxs(ly, {
      children: [g.jsx("img", {
        ...
        alt: "profile"
      }), g.jsx(vp, {$online: v.status?.isOnline})]
...
function q0({isOpen: r, onClose: i, user: s, onSubmit: u}) {
  ...
  const W = () => {
    ...
    try {
      ...
      c !== s.username && (se.username = c), p !== s.email && (se.email = p), v
      && (se.password = v), (Object.keys(se).length > 0 || E) && (H.append(
          "userUpdateRequest",
    ...
    try {
      const u = await he.post(`${Xe.apiBaseUrl}/channels/public`, s),
          c = {
            ...u.data.data,
            participants: [],
            lastMessageAt: u.data.data.lastMessageAt
          };
...
function Iv({isOpen: r, type: i, onClose: s, onCreateSuccess: u}) {
  const [c, d] = ue.useState({
      ...
      R = ue.useMemo(() => O.filter($ => $.id !== I).filter(
  ...
  return r ? g.jsx(fv, {
    onClick: s, children: g.jsxs(dv, {
      ...
      children: [g.jsxs(pv, {
        children: [g.jsx(hv,
            {children: i === "PUBLIC" ? "채널 만들기" : "개인 메시지 시작하기"}), g.jsx(wv, {
          onClick: s,
          children: "×"
        })]
      }), g.jsx(mv, {
...
const yo = bn((r, i) => ({
  readStatuses: {}, fetchReadStatuses: async () => {
    try {
      ...
      const c = (await he.get(`${Xe.apiBaseUrl}/read-statuses`,
          {params: {userId: s}})).data.data.reduce((d, p) => (d[p.channelId] = {
        id: p.id,
    ...
    try {
      ...
      let d;
      c ? d = await he.patch(`${Xe.apiBaseUrl}/read-statuses/${c.id}`,
          {newLastReadAt: new Date().toISOString()}) : d = await he.post(
          `${Xe.apiBaseUrl}/read-statuses`, {
            userId: u,
            channelId: s,
        ...
        readStatuses: {
          ...p.readStatuses,
          [s]: {id: d.data.data.id, lastReadAt: d.data.data.lastReadAt}
        }
      }))
    } catch (u) {
...
function _v({currentUser: r, activeChannel: i, onChannelSelect: s}) {
  ...
  const I = T => {
    ...
    const k = H.isPrivate ? "PRIVATE" : "PUBLIC";
    T[k] || (T[k] = []);
    T[k].push(H);
    return T;
  }, {});
...
`, vo = bn((r, i) => ({
      ...
      fetchMessages: async s => {
        try {
          const u = await he.get(`${Xe.apiBaseUrl}/messages`,
                  {params: {channelId: s}}),
              c = u.data.data[u.data.data.length - 1],
              d = (c == null ? void 0 : c.id) !== i().lastMessageId;
          return r(
              {messages: u.data.data, lastMessageId: c == null ? void 0 : c.id}), d
        } catch (u) {
      ...
      createMessage: async s => {
        try {
          ...
          return await d(s.channelId), r(
              p => ({messages: [...p.messages, c.data.data]})), c.data.data
        } catch (u) {
      ...
      attachments: {}, fetchAttachment: async s => {
        ...
        try {
          const u = await he.get(`${Xe.apiBaseUrl}/binary-contents/${s}`), {
            bytes: c,
            contentType: d,
            fileName: p,
            size: m
...
function m1({channel: r}) {
  const i = vo(P => P.messages), s = vo(P => P.fetchMessages),
      ...
      c = vo(P => P.stopPolling), d = Wt(P => P.profileImages),
      p = Dt(P => P.users), {
        attachments: m,
        fetchAttachment: v
      } = p1();
  ...
  const x = async (P, I) => {
        try {
          const R = await he.get(`${Xe.apiBaseUrl}/binary-contents/${P}`,
                  {responseType: "blob"}),
  ...
  return g.jsx(Qv, {
    children: g.jsx(qv, {
      children: O.map(P => {
        const I = p.find(R => R.id === P.senderId);
        return g.jsxs(bv, {
          children: [g.jsx(Gv, {
            children: g.jsx(Yv, {
    ...
    children: [u.length > 0 && g.jsx(a1, {children: u.map((O, P) => j(O, P))}),
      g.jsxs(e1, {
        ...
        children: [g.jsxs(n1, {
          ...
          onKeyPress: E,
          placeholder: !r.isPrivate ? `#${r.name}에 메시지 보내기` : "메시지 보내기"
        })]
      })]
  }) : null
}
...
function y1({channel: r}) {
  ...
  const c = r.participants.map(v => s.find(x => x.id === v)).filter(Boolean),
      d = c.filter(v => v.id !== i),
      p = c.length > 2,
      ...
      children: g.jsxs(Fv, {
        children: [p ? g.jsx($v, {
          ...
          children: [g.jsx(Vd, {src: d[0].profileId ? u[d[0].profileId] : Qt}),
            g.jsx(Vv, {online: d[0].status?.isOnline})]
        }), g.jsxs("div", {
  ...
  return ue.useEffect(() => {
    ...
    children: [g.jsxs(k1, {
      children: [i[r.profileId] ? g.jsx(bd, {src: i[r.profileId]}) : g.jsx(bd,
          {src: Qt}), g.jsx(Wp, {$online: r.status?.isOnline})]
...
function A1() {
  ...
  const u = [...r].sort(
      (c, d) => c.id === s ? -1 : d.id === s ? 1 : c.status?.isOnline
      && !d.status?.isOnline ? -1 : !c.status?.isOnline && d.status?.isOnline
          ? 1 : c.username.localeCompare(d.username));
  return g.jsxs(w1, {
...
function j1({isOpen: r, onClose: i}) {
  const [s, u] = ue.useState(""), [c, d] = ue.useState(
          ""), [p, m] = ue.useState(""), [A, B] = ue.useState(
          ""), [D, G] = ue.useState(""), [v, x] = ue.useState(
    ...
    children: g.jsxs(bp, {
      children: [g.jsx("h2", {children: "계정 만들기"}), g.jsxs("form", {
        ...
        children: [g.jsxs(Fi, {
          ...
          children: [g.jsxs(Bi,
              {children: ["닉네임 ", g.jsx(Eu, {children: "*"})]}), g.jsx(xo, {
            type: "text",
            value: A,
          ...
          children: [g.jsxs(Bi,
              {children: ["전화번호 ", g.jsx(Eu, {children: "*"})]}), g.jsx(xo, {
            type: "text",
          ...
          g.jsx(Gp, {type: "submit", children: "계속하기"}), g.jsx(L1, {
            onClick: i,
